...
const myBot = ['u566ceb03ebd1e2537bb260560bdef670'];
...
=> !yousound\n\
=> !youtube\n\
\n\n# http://line.me/ti/p/~jozakub2017  ^_^";
        var that = this;
    }
...
\n";
        ...
        if(txt === 'งง' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'งง' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
